// ---ATMEGA328p Fire Alarm---
//
// ---Submitted by Aditya Sant, 10795472 for CAB202 Semester 2, 2021---
...
//Bitwise operator fuction definitions
...
//Setup components including Analog-to-Digital conversion,
...
void process(void) {
  ...
  itoa(temp, (char *)temp_buf,10);
    ...
    //if value is above 62 degrees celisus,
    //activate buzzer and other columns of the LED Matrix
    if (temp >= 211)
    {
	  lcd.setCursor(0, 1);
      lcd.print("EVACUATE!");
